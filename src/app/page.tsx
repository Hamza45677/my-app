export default function Home() {
  return (
    <div className="bg-[#252B42] font-montserrat min-h-screen  -top-[590px] -left-[720px]">
      <div className="w-1322 h-91">
      ...
      <div className="flex justify-center">
        <section className="relative w-[699px] h-[496px] pt-40 pb-40 gap-10 ">
          <h5 className="text-[#23A6F0]  font-montserrat text-[16px] text-center font-bold leading-[24px] tracking-[0.1px]">
            Welcome
          </h5>
          <br />
          <br />

          <h1 className="text-center text-[#FFFFFF] text-[58px] font-montserrat font-bold leading-[80px] tracking-[0.2px]">
            Selling on the
            <br />
            internet like a pro
          </h1>
          ...
          <h4 className="font-montserrat text-xl font-normal leading-[30px] text-center text-[#FFFFFF] tracking-tight-custom">
          ...
          <div className="w-[365px] h-[52px] gap-[10px] ml-40  flex">
            <button className="w-[193px] h-[52px] rounded-md  bg-[#23A6F0]">
              <p className=" text-center  text-[#FFFFFF] font-montserrat text-sm font-bold leading-[22px] tracking-[0.2px]">
                Get Quote Now
              </p>
            </button>

            <button className="w-[162px]  gap-[10px] rounded-md border border-solid border-[#23A6F0] ">
              <p className="text-center text-[#23A6F0] font-montserrat text-sm font-bold leading-[22px] tracking-[0.2px]">
                Learn More
              </p>
            </button>
          </div>
        ...
        <div className="w-[1046px] h-[292px] mx-auto gap-[30px]">
          <div className="grid grid-cols-1 md:grid-cols-3 ">
            <div className="w-[328px] h-[292px] p-[35px_40px] bg-white shadow-[0px_13px_19px_#00000012] gap-[20px]">
              ...
              <br />
              <h5 className=" text-[16px] font-bold text-[#252B42] leading-6 tracking-[0.1px] text-left font-montserrat">
                Training Courses
              </h5>
              <br />
              <div className="w-[50px] h-[2px] bg-[#E74040]"></div>
              <br />
              <p className="w-[222px] h-[60px] text-sm text-[#737373] font-medium leading-[20px] tracking-[0.2px] text-left font-montserrat">
            ...
            <div className="w-[328px] h-[292px] p-[35px] bg-[#FFFFFF] shadow-[0px_13px_19px_#00000012]  flex flex-col gap-5">
              ...
              <div className="w-[50px] h-[2px] bg-[#E74040]"></div>
              <p className="w-[222px] h-[60px] text-[14px] text-[#737373] font-medium leading-5 tracking-[0.2px] text-left font-montserrat">
                The gradual accumulation of information about atomic and
                small-scale behaviour...
              </p>
            </div>
            ...
            <div className="w-[328px] h-[292px] p-[35px] bg-[#23A6F0] shadow-[0px_13px_19px_#00000012] text-white flex flex-col gap-5">
              ...
              <h5 className="text-[#FFFFFF] text-[16px] font-bold leading-6 tracking-[0.1px] text-left font-montserrat mb-2">
                Training Courses
              </h5>
              <div className="w-[50px] h-[2px] bg-[#FFFFFF]"></div>
              <p className="text-[#FFFFFF] text-[14px] font-medium leading-5 tracking-[0.2px] text-left font-montserrat">
                The gradual accumulation of information about atomic and
                small-scale behaviour...
              </p>
            </div>
